...
PC_MODEL_PATH = ""
IMG_MODEL_PATH = ""
MODEL_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_12_1/model_01650550.ckpt"
...
def init_all_feat():
	...
	if TRAINING_MODE == 3:
		img_pc_feat = np.empty([0,1000],dtype=np.float32)
