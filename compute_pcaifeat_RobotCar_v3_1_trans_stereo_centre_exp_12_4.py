...
PC_MODEL_PATH = ""
IMG_MODEL_PATH = ""
MODEL_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_12_4/model_01647549.ckpt"
...
def init_all_feat():
	...
	if TRAINING_MODE == 3:
		...
		pcai_feat = np.empty([0,EMBBED_SIZE],dtype=np.float32)
...
def init_fusion_network(pc_feat,img_feat,img_pc_feat):
	with tf.variable_scope("fusion_var"):
		...
		concat_feat = tf.layers.dropout(concat_feat,rate=0.5,training=False)
