...
PC_MODEL_PATH = ""
IMG_MODEL_PATH = ""
MODEL_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_12_6/model_002160721.ckpt"
...
def init_all_feat():
	...
	if TRAINING_MODE == 3:
		...
		pcai_feat = np.empty([0,5096],dtype=np.float32)
