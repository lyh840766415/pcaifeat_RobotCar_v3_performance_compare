...
from pointnetvlad_v3.pointnetandvlad_trans import *
...
PC_MODEL_PATH = ""
IMG_MODEL_PATH = ""
MODEL_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_19_2/model_00882294.ckpt"
...
def init_pcnetwork(step):
	with tf.variable_scope("pc_var"):
		...
		pc_feat,pc_trans_feat,pointnet_feat = pointnetvlad(pc_placeholder,trans_mat_placeholder,is_training_pl,bn_decay)	
	return pc_placeholder,is_training_pl,trans_mat_placeholder,pc_feat,pc_trans_feat,pointnet_feat
...
def init_pcainetwork():
	...
	#init sub-network
	if TRAINING_MODE != 2:
		pc_placeholder, is_training_pl, trans_mat_placeholder, pc_feat,pc_trans_feat,pointnet_feat = init_pcnetwork(step)
	if TRAINING_MODE != 1:
