...
PC_MODEL_PATH = ""
IMG_MODEL_PATH = ""
MODEL_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_22/model_00879293.ckpt"
...
def init_fusion_network(pc_feat,img_feat):
	with tf.variable_scope("fusion_var"):
		...
		pcai_feat = tf.layers.batch_normalization(pcai_feat, training = False)
