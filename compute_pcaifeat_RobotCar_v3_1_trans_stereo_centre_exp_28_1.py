...
PC_MODEL_PATH = ""
IMG_MODEL_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_28_1/img_model_00441147.ckpt"
MODEL_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_28_1/model_00441147.ckpt"
...
def init_imgnetwork(is_training = False):
	...
	with tf.variable_scope("fusion_var"):
		...
		t_p_relation = tf.nn.softmax(t_p_relation,dim = -1)
		t_p_g_img = tf.matmul(t_p_relation,g_img_net)
