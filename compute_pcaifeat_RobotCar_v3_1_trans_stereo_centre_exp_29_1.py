...
PC_MODEL_PATH = ""
IMG_MODEL_PATH = ""
MODEL_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_29_1/model_01752584.ckpt"
...
def train_one_step(sess,ops,train_feed_dict):
	...
	if TRAINING_MODE == 3:
		pc_feat,img_feat= sess.run([ops["pc_feat"],ops["img_feat"]],feed_dict = train_feed_dict)
		feat = {
			"pc_feat":pc_feat,
			"img_feat":img_feat}
		return feat
