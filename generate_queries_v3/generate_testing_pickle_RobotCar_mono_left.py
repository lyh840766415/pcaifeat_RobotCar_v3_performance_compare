...
PC_IMG_MATCH_FILE = 'mono_left_pointcloud_image_match_test.pickle'
...
def construct_query_and_database_sets(base_path, runs_folder, folders, pointcloud_fols, filename, p, output_name):
	...
	output_to_file(database_sets, "mono_left_RobotCar_"+output_name+'_evaluation_database.pickle')
	output_to_file(test_sets, "mono_left_RobotCar_"+output_name+'_evaluation_query.pickle')
