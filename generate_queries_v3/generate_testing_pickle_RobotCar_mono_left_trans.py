...
def construct_query_and_database_sets(base_path, runs_folder, folders, pointcloud_fols, filename, p, output_name):
	...
	for folder in folders:
		...
		for index, row in df_locations.iterrows():
			...
			img_filename = "%s_mono_left.png"%(pc_filename[:-4])
	...
	#print(database_sets)
	#print(test_sets)
	output_to_file(database_sets, "mono_left_trans_RobotCar_"+output_name+'_evaluation_database.pickle')
	output_to_file(test_sets, "mono_left_trans_RobotCar_"+output_name+'_evaluation_query.pickle')
