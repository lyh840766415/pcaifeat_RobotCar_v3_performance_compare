...
def construct_query_and_database_sets(base_path, runs_folder, folders, pointcloud_fols, filename, p, output_name):
	...
	for folder in folders:
		...
		for index, row in df_locations.iterrows():
			...
			img_filename = get_correspond_img(pc_filename)
	...
	output_to_file(database_sets, "stereo_centre_RobotCar_"+output_name+'_evaluation_database.pickle')
	output_to_file(test_sets, "stereo_centre_RobotCar_"+output_name+'_evaluation_query.pickle')
