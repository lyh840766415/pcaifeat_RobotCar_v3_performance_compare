...
def construct_query_and_database_sets(base_path, runs_folder, folders, pointcloud_fols, filename, p, output_name):
	...
	#print(database_sets)
	#print(test_sets)
	output_to_file(database_sets, "stereo_centre_trans_RobotCar_no_ground_"+output_name+'_evaluation_database.pickle')
	output_to_file(test_sets, "stereo_centre_trans_RobotCar_no_ground_"+output_name+'_evaluation_query.pickle')
