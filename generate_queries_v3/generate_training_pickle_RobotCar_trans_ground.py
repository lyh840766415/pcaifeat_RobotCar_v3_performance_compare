...
#global variable
PC_PATH = "/data/lyh/RobotCar/pc_img_ground_0310/20m_10dis_color_resize/"
...
def main():
	...
	construct_query_dict(df_train,"training_queries_RobotCar_trans_ground.pickle")
	construct_query_dict(df_test,"test_queries_RobotCar_trans_ground.pickle")
