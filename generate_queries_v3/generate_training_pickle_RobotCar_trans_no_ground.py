...
def main():
	...
	construct_query_dict(df_train,"training_queries_RobotCar_trans_no_ground.pickle")
	construct_query_dict(df_test,"test_queries_RobotCar_trans_no_ground.pickle")
