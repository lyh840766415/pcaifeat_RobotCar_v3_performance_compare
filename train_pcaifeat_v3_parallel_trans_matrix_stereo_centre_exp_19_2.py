...
# log path
LOG_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_19_2"
...
def init_pcainetwork():
	...
	with tf.control_dependencies(update_ops):
		...
		if TRAINING_MODE == 3:
			...
			fusion_train_op = optimizer.minimize(finally_loss, global_step=step, var_list=local_fusion_variable+resnet_variable)
