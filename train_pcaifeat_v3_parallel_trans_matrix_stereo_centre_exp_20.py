...
import nets_v3.resnet_v1_trans_bn as resnet
import shutil
...
# log path
LOG_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_20"
...
def load_data(train_file_idxs):
	...
	while True:
		...
		if (cnt*LOAD_FEAT_RATIO)%300 == 0:
			...
			pc_data,img_data = load_img_pc_from_net(eval_pc_filenames,eval_img_filenames,pool,False)
			...
			#load pc&img data from file
			pc_data,img_data = load_img_pc_from_net(load_pc_filenames,load_img_filenames,pool,False)
