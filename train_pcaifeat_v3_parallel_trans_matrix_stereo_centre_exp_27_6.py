...
# log path
LOG_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_27_6"
...
def init_pcainetwork():
	...
	with tf.control_dependencies(update_ops):
		if TRAINING_MODE != 2:
			pc_train_op = optimizer.minimize(pc_loss, global_step=step, var_list=vlad_variable+pc_variable+local_fusion_variable)
		if TRAINING_MODE != 1:
