...
RAND_INIT = False
# model path
MODEL_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_31_1/model_00441147.ckpt"
PC_MODEL_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_6_4/pc_model_00441147.ckpt"
IMG_MODEL_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_31_1/model_00441147.ckpt"
# log path
LOG_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_31_4"
...
def init_network_variable(sess,train_saver):
	...
	if TRAINING_MODE == 3:
		...
		#train_saver['pc_load_saver'].restore(sess,PC_MODEL_PATH)
		#print("pc_model restored")
		train_saver['img_load_saver'].restore(sess,IMG_MODEL_PATH)
		print("img_model restored")
