...
RAND_INIT = True
# model path
MODEL_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_31_0/model_00441147.ckpt"
PC_MODEL_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_31_0/model_00441147.ckpt"
...
# log path
LOG_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_31_5_2"
...
def init_imgnetwork():
	with tf.variable_scope("img_var"):
		...
		img_feat = tf.layers.dense(img_feat_after_pooling, EMBBED_SIZE)
...
def init_train_saver():
	...
	img_load_variable = [v for v in variables if v.name.split('/')[0] =='img_var' and v.name.split('/')[1] != "dense"]
