...
# log path
LOG_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_4_6"
...
def init_fusion_network(pc_feat,img_feat):
	with tf.variable_scope("fusion_var"):
		pc_weight = tf.layers.dense(pc_feat,1,activation=tf.nn.relu)
		img_weight = tf.layers.dense(img_feat,1,activation=tf.nn.relu)
