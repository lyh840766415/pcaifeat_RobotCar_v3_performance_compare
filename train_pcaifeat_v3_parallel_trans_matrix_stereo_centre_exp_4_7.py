...
# log path
LOG_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3_performance_compare/log/train_save_trans_exp_4_7"
...
def init_fusion_network(pc_feat,img_feat):
	with tf.variable_scope("fusion_var"):
		pc_weight = tf.layers.dense(pc_feat,pc_feat.get_shape()[1],activation=tf.nn.relu)
		img_weight = tf.layers.dense(img_feat,img_feat.get_shape()[1],activation=tf.nn.relu)
		pc_feat = pc_weight*pc_feat
