...
std_div = np.std(ALL_PCAI, axis=0)
std_div = np.tile(std_div, (ALL_PCAI.shape[0],1))
new_pcai = ALL_PCAI/std_div
std_div = np.std(new_pcai, axis=0)
print(std_div)
...
def main():
	...
	file = 'whitening_drop_feat_test.txt'
